...
class UpdateKategoriBarangRequest extends FormRequest
{
    ...
    {
        $kategoriBarangId = $this->route('kategori_barang');
        ...
        return [
            'nama_kategori' => [
                ...
                'string',
                'max:100',
                Rule::unique('kategori_barang', 'nama_kategori')->ignore($kategoriBarangId)
            ],
            'kode_kategori' => [
                'sometimes',
                'required',
                ...
                'alpha_num',
                'uppercase',
                Rule::unique('kategori_barang', 'kode_kategori')->ignore($kategoriBarangId)
            ],
            'deskripsi' => [
                'sometimes',
                'nullable',
